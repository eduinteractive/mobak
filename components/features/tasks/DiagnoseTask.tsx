...
const TaskVideos = {
	MOBAK_1_2: {
		BALANCING_1_2: require("@/assets/videos/BALANCING_1_2.VIDEO.mp4"),
		ROLLING_1_2: require("@/assets/videos/ROLLING_1_2.VIDEO.mp4"),
		JUMPING_1_2: require("@/assets/videos/JUMPING_1_2.VIDEO.mp4"),
		RUNNING_1_2: require("@/assets/videos/RUNNING_1_2.VIDEO.mp4"),
		BOUNCING_1_2: require("@/assets/videos/BOUNCING_1_2.VIDEO.mp4"),
		CATCHING_1_2: require("@/assets/videos/CATCHING_1_2.VIDEO.mp4"),
		THROWING_1_2: require("@/assets/videos/THROWING_1_2.VIDEO.mp4"),
		DRIBBLING_1_2: require("@/assets/videos/DRIBBLING_1_2.VIDEO.mp4"),
	},
	MOBAK_3_4: {
		BALANCING_3_4: require("@/assets/videos/BALANCING_3_4.VIDEO.mp4"),
		ROLLING_3_4: require("@/assets/videos/ROLLING_3_4.VIDEO.mp4"),
		JUMPING_3_4: require("@/assets/videos/JUMPING_3_4.VIDEO.mp4"),
		RUNNING_3_4: require("@/assets/videos/RUNNING_3_4.VIDEO.mp4"),
		BOUNCING_3_4: require("@/assets/videos/BOUNCING_3_4.VIDEO.mp4"),
		CATCHING_3_4: require("@/assets/videos/CATCHING_3_4.VIDEO.mp4"),
		THROWING_3_4: require("@/assets/videos/THROWING_3_4.VIDEO.mp4"),
		DRIBBLING_3_4: require("@/assets/videos/DRIBBLING_3_4.VIDEO.mp4"),
	},
};
